...
* @returns  AbstractDB
*/
public static function getLayer($layerType, $libraryPath, $dbType, $preferredResType = ANYDB_RES_ASSOC) {
    ...
    switch ($layer) {
        case 'DBX':
			require_once $path . 'DbxDB.php';
            $res = new DbxDB($libraryPath, $dbType, $preferredResType);
            break;
        case 'METABASE':
        ...
        case 'PHPLIB':
            ...
            $res = new PhplibDB($libraryPath, $dbType, $preferredResType);
            break;
        case 'ADODB':
...
* @returns  AbstractDB
*/
public static function checkForDB($dbType) {
